...
int main(int argc, char* argv[]) {
    if (argc != 5) {
        throw std::runtime_error("Correct usage: ./siw <domain:str> <problem:str> <arity:int> <enable_grounding:bool>");
    }
    std::cout << "Started siw search." << std::endl;
    ...
    auto goal_test = std::make_unique<planners::CountGoalTest>(problem);
