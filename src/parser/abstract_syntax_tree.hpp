...
public:
    ...
    NameNode();
    NameNode(char prefix, const std::vector<char>& characters);
    ~NameNode() override;
...
public:
    ...
    IdentifierNode();
    IdentifierNode(const std::vector<char>& characters);
...
public:
    ...
    StringNode();
    StringNode(const std::vector<char>& characters);
    ~StringNode() override;
...
public:
    ...
    NameAndStringNode();
    NameAndStringNode(const NameNode& name_node, const StringNode& string_node);
...
public:
    std::vector<std::pair<std::string, std::string>> feature_effect_nodes;
