...
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::Identifier, name)
...
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::FeatureCondition, type, key)
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::FeatureEffect, type, key)
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::Conditions, memory_condition, feature_conditions)
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::Effects, memory_effect, feature_effects)
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::LoadRule, conditions, effects)
