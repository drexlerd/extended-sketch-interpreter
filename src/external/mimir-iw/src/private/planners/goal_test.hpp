...
private:
    ...
    std::unordered_map<sketches::extended_sketch::MemoryState, std::shared_ptr<const dlplan::policy::Policy>> sketches_by_memory_state_;
...
public:
    ExtendedSketchGoalTest(
        ...
        std::unordered_map<sketches::extended_sketch::MemoryState, std::shared_ptr<const dlplan::policy::Policy>> sketches_by_memory_state)
