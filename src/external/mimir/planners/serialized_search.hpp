...
namespace mimir::planners {
    class SerializedSearch {
            ...
            bool find_plan(std::vector<formalism::Action>& plan) {
                ...
                do {
                    ...
                    if (found_partial_solution) {
                        ...
                        inner_search_.print_statistics();
        ...
        void print_statistics() const {
            ...
            std::cout << "Average effective width " << average_effective_arity << std::endl;
            std::cout << "Maximum effective width " << maximum_effective_arity << std::endl;
