...
namespace mimir::planners {
    class GoalTest {
        ...
        public:
            ...
            virtual void set_initial_state(const StateData&) { };
            ...
            virtual void print_statistics() const {
                std::cout << "Num goal tests: " << count_goal_test_ << std::endl;
            }
    };
    ...
    class TopGoalTest : public GoalTest {
        ...
        public:
            ...
            virtual void print_statistics() const override {
                std::cout << "Top goal time: " << time_top_goal_ns_  / (int64_t) 1E6 << " ms" << std::endl;
            }
    };
    ...
    class CountGoalTest : public GoalTest {
        ...
        public:
            ...
            virtual void print_statistics() const override {
                std::cout << "Count top goal time: " << time_count_top_goal_ns_  / (int64_t) 1E6 << " ms" << std::endl;
            }
    };
    ...
    class SketchGoalTest : public GoalTest {
        ...
        public:
            SketchGoalTest(
                ...
                const dlplan::policy::Policy& sketch) : GoalTest(problem), instance_(instance), sketch_(sketch), time_top_goal_ns_(0), time_sketch_goal_ns_(0) {
            ...
            virtual void print_statistics() const override {
                GoalTest::print_statistics();
                std::cout << "Top goal time: " << time_top_goal_ns_  / (int64_t) 1E6 << " ms" << std::endl;
                std::cout << "Sketch goal time: " << time_sketch_goal_ns_  / (int64_t) 1E6 << " ms" << std::endl;
            }
    };
}
