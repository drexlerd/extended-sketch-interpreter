...
namespace std
{
    ...
    std::size_t hash<mimir::formalism::ImplicationList>::operator()(const mimir::formalism::ImplicationList& implication_list) const { return hash_vector(implication_list); }
    ...
    bool equal_to<mimir::formalism::ImplicationList>::operator()(const mimir::formalism::ImplicationList& lhs, const mimir::formalism::ImplicationList& rhs) const
    {
        if (lhs.size() != rhs.size())
        {
            return false;
