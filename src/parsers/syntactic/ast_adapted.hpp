...
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::ArgumentRegister, reference)
BOOST_FUSION_ADAPT_STRUCT(sketches::extended_sketch::ast::ArgumentConcept, reference)
