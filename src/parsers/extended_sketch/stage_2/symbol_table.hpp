...
struct SymbolTables {
    SymbolTable<sketches::parsers::extended_sketch::stage_1::ast::RegisterDefinition, Register> registers;
    SymbolTable<sketches::parsers::extended_sketch::stage_1::ast::MemoryStateDefinition, MemoryState> memory_states;
