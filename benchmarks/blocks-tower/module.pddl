(:module
    ...
    (:extended_sketch
        ...
        (:load_rule (:conditions (:memory m0) (:c_n_gt W)) (:effects (:memory m1) (:load (r0 W))))
        (:load_rule (:conditions (:memory m1) (:c_n_gt M)) (:effects (:memory m2) (:load (r1 M))))
        (:call_rule (:conditions (:memory m2))             (:effects (:memory m3) (:call clear(r0 r1))))
